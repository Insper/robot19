...
//BufferedImage imagem;
     ...
     */
    public GraficoMapAStar (GridMap g){
        this(g, 800, 600 );
    }
     ...
     */
    public GraficoMapAStar(GridMap g, int width, int height){
        this.map = g;
        this.width = width;
        this.height = height;
...
// Rodando a busca
        BuscaAStar busca = new BuscaAStar(map, sb, g);
